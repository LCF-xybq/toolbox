...
from cv.utils import build_from_cfg, is_list_of
from cv.utils.ext_loader import check_ops_exist
    ...
    def add_params(self, params, module, prefix='', is_dcn_module=None):
        ...
        if check_ops_exist():
            raise NotImplementedError(
                'DeformConv2d and ModulatedDeformConv2d are not implemented!'
            )
        else:
            is_dcn_module = False
