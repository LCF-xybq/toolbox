...
from cv import print_log
from cv.utils import digit_version
from .scatter_gather import scatter_kwargs

TORCH_VERSION = torch.__version__


class MulitiDistributedDataParallel(DistributedDataParallel):
    ...
    def train_step(self, *inputs, **kwargs):
        ...
        if (digit_version(TORCH_VERSION) >= digit_version('1.11.0a0')):
