...
from cv.parallel import SingleGPUDataParallel
from cv.runner import HOOKS, IterBasedRunner, get_dist_info
from cv.utils import build_from_cfg, get_logger

from sources.core import DistEvalIterHook, EvalIterHook, build_optimizers
from sources.core.distributed_wrapper import DistributedDataParallelWrapper
from sources.datasets.builder import build_dataset, build_dataloader
...
def init_random_seed(seed=None, device='cuda'):
    ...
    # Make sure all ranks share the same random seed
...
def _non_dist_train(model,
    ...
    model = SingleGPUDataParallel(model, device_ids=range(cfg.gpus))
