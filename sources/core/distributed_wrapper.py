...
from cv.parallel import MODULE_WRAPPERS, MulitiDistributedDataParallel
from cv.parallel.scatter_gather import scatter_kwargs
...
class DistributedDataParallelWrapper(nn.Module):
    ...
    there is a need to wrap different modules in the models
    ...
    1. Wrap the modules in the models with separate MultiDistributedDataParallel.
    ...
    def to_ddp(self, device_ids, dim, broadcast_buffers,
        ...
        """Wrap models with separate MultiDistributedDataParallel.
        ...
        for name, module in self.module._modules.items():
            if next(module.parameters(), None) is None:
                ...
                module = MulitiDistributedDataParallel(
                    module.cuda(),
                    device_ids=device_ids,
                    dim=dim,
                    broadcast_buffers=broadcast_buffers,
    ...
    def scatter(self, inputs, kwargs, device_ids):
        ...
        Args:
            ...
            kwargs (dict): Args for
                ``cv.parallel.scatter_gather.scatter_kwargs``.
